...
export async function initialize(
  ...
  // const googleIssuer = await Issuer.discover("https://ping.incodedemo.com/");
...
//https://374c-76-95-83-56.ngrok.io
  // const googleIssuer = await Issuer.discover("http://54.91.193.152:3000/");
  // console.log("OpendId issuer created");
  // const client = new googleIssuer.Client({
  //   client_id: process.env.OAUTH_CLIENT_ID!,
  //   client_secret: process.env.OAUTH_CLIENT_SECRET!,
  ...
  const client = new googleIssuer.Client({
    client_id: process.env.OAUTH_CLIENT_ID!,
    client_secret: process.env.OAUTH_CLIENT_SECRET!,
    redirect_uris: [`http://54.91.193.152:8080/auth/callback`],
    scope: "openid",
    response_types: ["code"]
  ...
  //   client_id: process.env.OAUTH_CLIENT_ID!,
  //   client_secret: process.env.OAUTH_CLIENT_SECRET!,
  //   redirect_uris: [`https://374c-76-95-83-56.ngrok.io/auth/callback`],
  //   scope: "openid",
  //   response_types: ["code"]
